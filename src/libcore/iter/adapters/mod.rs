...
#[unstable(issue = "0", feature = "inplace_iteration")]
unsafe impl<S: Iterator, B, I: Iterator, F> SourceIter for Map<I, F> where
    F: FnMut(I::Item) -> B,
...
#[unstable(issue = "0", feature = "inplace_iteration")]
unsafe impl<S: Iterator, I: Iterator> SourceIter for Enumerate<I> where I: SourceIter<Source = S> {
    type Source = S;
...
#[unstable(feature = "trusted_len", issue = "37572")]
unsafe impl<I> TrustedLen for Peekable<I>
    where I: TrustedLen,
{}

#[unstable(issue = "0", feature = "inplace_iteration")]
unsafe impl<S: Iterator, I: Iterator> SourceIter for Peekable<I> where I: SourceIter<Source = S> {
    type Source = S;
...
#[unstable(issue = "0", feature = "inplace_iteration")]
unsafe impl<S: Iterator, I: Iterator> SourceIter for Skip<I> where I: SourceIter<Source = S> {
    type Source = S;
...
#[unstable(issue = "0", feature = "inplace_iteration")]
unsafe impl<S: Iterator, I: Iterator> SourceIter for Fuse<I> where I: SourceIter<Source = S> {
    type Source = S;
