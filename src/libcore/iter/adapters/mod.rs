...
#[unstable(issue = "0", feature = "inplace_iteration")]
impl<S: Iterator, B, I: Iterator, F> SourceIter for Map<I, F> where
    F: FnMut(I::Item) -> B,
...
#[unstable(issue = "0", feature = "inplace_iteration")]
impl<S: Iterator, I: Iterator> SourceIter for Enumerate<I> where I: SourceIter<Source = S> {
    type Source = S;
...
#[unstable(issue = "0", feature = "inplace_iteration")]
impl<S: Iterator, I: Iterator> SourceIter for Peekable<I> where I: SourceIter<Source = S> {
    type Source = S;
...
#[unstable(issue = "0", feature = "inplace_iteration")]
impl<S: Iterator, I: Iterator> SourceIter for Skip<I> where I: SourceIter<Source = S> {
    type Source = S;
...
#[unstable(issue = "0", feature = "inplace_iteration")]
impl<S: Iterator, I: Iterator> SourceIter for Fuse<I> where I: SourceIter<Source = S> {
    type Source = S;
